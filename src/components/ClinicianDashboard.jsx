        ...
        <div className="min-h-screen bg-gray-900 p-8 text-white flex items-center justify-center">
            ...
            >
                <div className="flex items-center justify-center mb-8">
                    <HeartPulse className="w-16 h-16 mr-4 text-blue-500" />
                </div>
                <h1 className="text-4xl font-bold mb-4">Clinician Dashboard</h1>
                <p className="text-xl text-gray-400">Coming Soon - This feature is under development (80% complete)</p>
            </motion.div>
        </div>
    );
};
